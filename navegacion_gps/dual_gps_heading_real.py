...
class DualGpsHeadingReal(Node):
    def __init__(self):
        ...
        # +π/2; equivalent to adding π over a -π/2 baseline correction.
        ...
        self.get_logger().info(
            ...
            f"(offset={math.degrees(self._offset):.1f}°)"
        )
    ...
    def _on_heading(self, msg: Imu) -> None:
        ...
        yaw_corrected = yaw + self._offset
        # Normalise to (-π, π]
        ...
        # Preserve angular_velocity / linear_acceleration if present; otherwise mark unknown.
