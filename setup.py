...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'sim_global_consistency_check = navegacion_gps.sim_global_consistency_check:main',
            'sim_global_drift_check = navegacion_gps.sim_global_drift_check:main',
            'sim_global_ekf_forensics = navegacion_gps.sim_global_ekf_forensics:main',
            'sim_global_ekf_forensics_benchmark = navegacion_gps.sim_global_ekf_forensics_benchmark:main',
            'sim_global_motion_benchmark = navegacion_gps.sim_global_motion_benchmark:main',
            'sim_global_postgoal_orbit_check = navegacion_gps.sim_global_postgoal_orbit_check:main',
            'sim_global_postgoal_forensics = navegacion_gps.sim_global_postgoal_forensics:main',
