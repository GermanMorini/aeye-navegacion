...
def generate_launch_description():
    ...
    default_localization_params_file = _resolve_config_file_path(
    ...
    default_nav2_params_file = _resolve_config_file_path(
        gps_wpf_dir, "nav2_local_v2_params.yaml"
    )
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                ...
                default_value=default_localization_params_file,
            ),
            DeclareLaunchArgument(
            ...
            DeclareLaunchArgument(
                "keepout_mask_yaml",
                default_value=default_keepout_mask_yaml,
            ),
            ...
            DeclareLaunchArgument("fromll_frame", default_value="odom"),
